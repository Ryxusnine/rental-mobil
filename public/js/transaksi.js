$(document).ready(function () {
  ...
  $("#Sopir").change(function () {
    var harga = $("option:selected", this).attr("Sopir");
    $("#TarifSopirPerhari").val(harga);
    total();
  });

  // RANGE DATE
  $("#tanggalSelesaiRental").change(function () {
    var tanggalMulai = $("input[name='tanggalRental_submit']").val();
    var tanggalAkhir = $("input[name='tanggalSelesaiRental_submit']").val();
  ...
  function total() {
    var hargaSewaMobil = $("#hargaSewa").val();
