      ...
      <div class="bawah-navbar bg-white mt-4 shadow-sm p-2">
         <div class="panel panel-default">
            <div class="panel-heading">
               <a href="v_pelanggan" class="rounded-pill float-right btn btn-custom btn-sm shadow-none mt-0" style="background:grey">Pelanggan</a>
               <a href="v_karyawan" class="rounded-pill float-right btn btn-custom btn-sm shadow-none mt-0">Karyawan</a>
